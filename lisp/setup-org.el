...
(use-package org
  ...
  (setq org-agenda-files '("~/notes/expd/denote" "~/notes/daily" "~/notes"))
...
>>>>>>> Stashed changes
  ...
  (defun my/org-add-export-dir (orig-fun extension &optional subtreep pub-dir)
  ...
  (advice-add 'org-export-output-file-name :around #'my/org-add-export-dir)
